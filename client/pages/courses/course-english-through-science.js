...
import styles from "../../styles/pages/Course-content.module.scss";
...
export default function Courseenglishthroughscience({ data }) {
  return (
    <MainLayout
      // ------------------------------------------
      ...
      // ------------------------------------------
      title={data.courseenglishthroughsciencepagedata.meta.title}
      keywords={data.courseenglishthroughsciencepagedata.meta.keywords}
      description={data.courseenglishthroughsciencepagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.courseenglishthroughsciencepagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={
                data.courseenglishthroughsciencepagedata.firstscreen.h1title
              }
              h1subtitle={
                data.courseenglishthroughsciencepagedata.firstscreen.h1subtitle
              }
              altimage={
                data.courseenglishthroughsciencepagedata.firstscreen.imagealt
              }
              nameimage={
                data.courseenglishthroughsciencepagedata.firstscreen.imagename
              }
              urlvideo={
                data.courseenglishthroughsciencepagedata.firstscreen.urlvideo
              }
              titlevideo={
                data.courseenglishthroughsciencepagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.courseenglishthroughsciencepagedata.firstscreen
                  .videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
      ...
      {data.courseenglishthroughsciencepagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.courseenglishthroughsciencepagedata.landingmonolink
              }
      ...
      0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.courseenglishthroughsciencepagedata.faq.faqtitle}
              faqdata={
                data.courseenglishthroughsciencepagedata.faq.questionanswer
              }
            />
          </div>
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/courseenglishthroughscience_${lang}`
  );
