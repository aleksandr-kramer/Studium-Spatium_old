...
export default function Studentconsultation({ data }) {
  return (
    <MainLayout
      // ------------------------------------------
      ...
      // ------------------------------------------
      title={data.studentconsultationpagedata.meta.title}
      keywords={data.studentconsultationpagedata.meta.keywords}
      description={data.studentconsultationpagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.studentconsultationpagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={data.studentconsultationpagedata.firstscreen.h1title}
              h1subtitle={
                data.studentconsultationpagedata.firstscreen.h1subtitle
              }
              altimage={data.studentconsultationpagedata.firstscreen.imagealt}
              nameimage={data.studentconsultationpagedata.firstscreen.imagename}
              urlvideo={data.studentconsultationpagedata.firstscreen.urlvideo}
              titlevideo={
                data.studentconsultationpagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.studentconsultationpagedata.firstscreen.videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
          </div>
      ...
      {data.studentconsultationpagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.studentconsultationpagedata.landingmonolink
              }
      ...
      {Object.keys(data.studentconsultationpagedata.faq).length !== 0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.studentconsultationpagedata.faq.faqtitle}
              faqdata={data.studentconsultationpagedata.faq.questionanswer}
            />
          </div>
      ...
      {data.studentconsultationpagedata.landingmultilink.length !== 0 ? (
          ...
          <div className={styles.main__landingmultilink__container}>
            <LandingMultiLink
              listlandingmultilink={
                data.studentconsultationpagedata.landingmultilink
              }
            />
          </div>
          <div
      ...
      {data.studentconsultationpagedata.landingmultilink !== 0 ? (
        <FixLinks
          fixlinkdata={data.studentconsultationpagedata.landingmultilink}
        />
      ) : null}
    </MainLayout>
  );
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/studentconsultation_${lang}`
  );
