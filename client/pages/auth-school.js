...
export default function Authschool({ data }) {
  return (
    ...
    >
      ...
      {data.authschoolpagedata.landingmonolink.length !== 0 ? (
      ...
      {Object.keys(data.authschoolpagedata.faq).length !== 0 ? (
      ...
      {data.authschoolpagedata.landingmultilink.length !== 0 ? (
      ...
      {data.authschoolpagedata.landingmultilink !== 0 ? (
