...
export default function Puapmoduleprojectactivities({ data }) {
  return (
    <MainLayout
      // ------------------------------------------
      ...
      // ------------------------------------------
      title={data.puapmoduleprojectactivitiespagedata.meta.title}
      keywords={data.puapmoduleprojectactivitiespagedata.meta.keywords}
      description={data.puapmoduleprojectactivitiespagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.puapmoduleprojectactivitiespagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={
                data.puapmoduleprojectactivitiespagedata.firstscreen.h1title
              }
              h1subtitle={
                data.puapmoduleprojectactivitiespagedata.firstscreen.h1subtitle
              }
              altimage={
                data.puapmoduleprojectactivitiespagedata.firstscreen.imagealt
              }
              nameimage={
                data.puapmoduleprojectactivitiespagedata.firstscreen.imagename
              }
              urlvideo={
                data.puapmoduleprojectactivitiespagedata.firstscreen.urlvideo
              }
              titlevideo={
                data.puapmoduleprojectactivitiespagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.puapmoduleprojectactivitiespagedata.firstscreen
                  .videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
      ...
      <section className={styles.main__h2component}>
        <div className={styles.main__h2component__container}>
          <H2Component
            H2Title={data.puapdata.modulespuap[1].titleaboutmodule}
            H2ComponentSubtitle={data.puapdata.modulespuap[1].aboutmodule}
      ...
      <section className={styles.main__h2columnlist}>
        ...
        <div className={styles.main__h2columnlist__container}>
          <H2ColumnList
            nameofmodule={data.puapdata.modulespuap[1].namemodule}
            h2columnlistdata={data.puapdata.modulespuap[1].generalaboutmodule}
          />
        </div>
      </section>
      ...
      <section className={styles.main__listoftopic}>
        <div className={styles.main__listoftopic__container}>
          <ListOfTopic
            listoftopicdata={data.puapdata.modulespuap[1].listoftopicmodule}
          />
        </div>
      </section>
      ...
      {data.puapmoduleprojectactivitiespagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.puapmoduleprojectactivitiespagedata.landingmonolink
              }
      ...
      {Object.keys(data.puapmoduleprojectactivitiespagedata.faq).length !==
      0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.puapmoduleprojectactivitiespagedata.faq.faqtitle}
              faqdata={
                data.puapmoduleprojectactivitiespagedata.faq.questionanswer
              }
            />
          </div>
      ...
      {data.puapmoduleprojectactivitiespagedata.landingmultilink.length !==
      0 ? (
          ...
          <div className={styles.main__landingmultilink__container}>
            <LandingMultiLink
              listlandingmultilink={
                data.puapmoduleprojectactivitiespagedata.landingmultilink
              }
            />
          </div>
          <div
      ...
      {data.puapmoduleprojectactivitiespagedata.landingmultilink !== 0 ? (
        <FixLinks
          fixlinkdata={
            data.puapmoduleprojectactivitiespagedata.landingmultilink
          }
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/puapmoduleprojectactivities_${lang}`
  );
