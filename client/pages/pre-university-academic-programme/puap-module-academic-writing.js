...
export default function Puapmoduleacademicwriting({ data }) {
  return (
    <MainLayout
      // ------------------------------------------
      ...
      // ------------------------------------------
      title={data.puapmoduleacademicwritingpagedata.meta.title}
      keywords={data.puapmoduleacademicwritingpagedata.meta.keywords}
      description={data.puapmoduleacademicwritingpagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.puapmoduleacademicwritingpagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={
                data.puapmoduleacademicwritingpagedata.firstscreen.h1title
              }
              h1subtitle={
                data.puapmoduleacademicwritingpagedata.firstscreen.h1subtitle
              }
              altimage={
                data.puapmoduleacademicwritingpagedata.firstscreen.imagealt
              }
              nameimage={
                data.puapmoduleacademicwritingpagedata.firstscreen.imagename
              }
              urlvideo={
                data.puapmoduleacademicwritingpagedata.firstscreen.urlvideo
              }
              titlevideo={
                data.puapmoduleacademicwritingpagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.puapmoduleacademicwritingpagedata.firstscreen
                  .videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
      ...
      <section className={styles.main__h2component}>
        <div className={styles.main__h2component__container}>
          <H2Component
            H2Title={data.puapdata.modulespuap[2].titleaboutmodule}
            H2ComponentSubtitle={data.puapdata.modulespuap[2].aboutmodule}
      ...
      <section className={styles.main__h2columnlist}>
        ...
        <div className={styles.main__h2columnlist__container}>
          <H2ColumnList
            nameofmodule={data.puapdata.modulespuap[2].namemodule}
            h2columnlistdata={data.puapdata.modulespuap[2].generalaboutmodule}
          />
        </div>
      </section>
      ...
      <section className={styles.main__listoftopic}>
        <div className={styles.main__listoftopic__container}>
          <ListOfTopic
            listoftopicdata={data.puapdata.modulespuap[2].listoftopicmodule}
          />
        </div>
      </section>
      ...
      {data.puapmoduleacademicwritingpagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.puapmoduleacademicwritingpagedata.landingmonolink
              }
      ...
      {Object.keys(data.puapmoduleacademicwritingpagedata.faq).length !== 0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.puapmoduleacademicwritingpagedata.faq.faqtitle}
              faqdata={
                data.puapmoduleacademicwritingpagedata.faq.questionanswer
              }
            />
          </div>
      ...
      {data.puapmoduleacademicwritingpagedata.landingmultilink.length !== 0 ? (
          ...
          <div className={styles.main__landingmultilink__container}>
            <LandingMultiLink
              listlandingmultilink={
                data.puapmoduleacademicwritingpagedata.landingmultilink
              }
            />
          </div>
          <div
      ...
      {data.puapmoduleacademicwritingpagedata.landingmultilink !== 0 ? (
        <FixLinks
          fixlinkdata={data.puapmoduleacademicwritingpagedata.landingmultilink}
        />
      ) : null}
    </MainLayout>
  );
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/puapmoduleacademicwriting_${lang}`
  );
