    ...
    >
      ...
      <section className={styles.main__h2component}>
        <div className={styles.main__h2component__container}>
          <H2Component
            H2Title={data.puapdata.modulespuap[3].titleaboutmodule}
            H2ComponentSubtitle={data.puapdata.modulespuap[3].aboutmodule}
      ...
      <section className={styles.main__h2columnlist}>
        ...
        <div className={styles.main__h2columnlist__container}>
          <H2ColumnList
            nameofmodule={data.puapdata.modulespuap[3].namemodule}
            h2columnlistdata={data.puapdata.modulespuap[3].generalaboutmodule}
          />
        </div>
      </section>
      ...
      <section className={styles.main__listoftopic}>
        <div className={styles.main__listoftopic__container}>
          <ListOfTopic
            listoftopicdata={data.puapdata.modulespuap[3].listoftopicmodule}
          />
        </div>
      </section>
