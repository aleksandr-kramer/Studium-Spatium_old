...
export default function Puapwhoistheprogramfor({ data }) {
  return (
    <MainLayout
      ...
      // ------------------------------------------
      title={data.puapwhoistheprogramforpagedata.meta.title}
      keywords={data.puapwhoistheprogramforpagedata.meta.keywords}
      description={data.puapwhoistheprogramforpagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.puapwhoistheprogramforpagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={data.puapwhoistheprogramforpagedata.firstscreen.h1title}
              h1subtitle={
                data.puapwhoistheprogramforpagedata.firstscreen.h1subtitle
              }
              altimage={
                data.puapwhoistheprogramforpagedata.firstscreen.imagealt
              }
              nameimage={
                data.puapwhoistheprogramforpagedata.firstscreen.imagename
              }
              urlvideo={
                data.puapwhoistheprogramforpagedata.firstscreen.urlvideo
              }
              titlevideo={
                data.puapwhoistheprogramforpagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.puapwhoistheprogramforpagedata.firstscreen.videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
          </div>
      ...
      {data.puapwhoistheprogramforpagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.puapwhoistheprogramforpagedata.landingmonolink
              }
      ...
      {Object.keys(data.puapwhoistheprogramforpagedata.faq).length !== 0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.puapwhoistheprogramforpagedata.faq.faqtitle}
              faqdata={data.puapwhoistheprogramforpagedata.faq.questionanswer}
            />
          </div>
      ...
      {data.puapwhoistheprogramforpagedata.landingmultilink.length !== 0 ? (
          ...
          <div className={styles.main__landingmultilink__container}>
            <LandingMultiLink
              listlandingmultilink={
                data.puapwhoistheprogramforpagedata.landingmultilink
              }
            />
          </div>
          <div
      ...
      {data.puapwhoistheprogramforpagedata.landingmultilink !== 0 ? (
        <FixLinks
          fixlinkdata={data.puapwhoistheprogramforpagedata.landingmultilink}
        />
      ) : null}
    </MainLayout>
  );
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/puapwhoistheprogramfor_${lang}`
  );
