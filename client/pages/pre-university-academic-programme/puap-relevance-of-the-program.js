...
export default function Puaprelevanceoftheprogram({ data }) {
  return (
    <MainLayout
      ...
      // ------------------------------------------
      title={data.puaprelevanceoftheprogrampagedata.meta.title}
      keywords={data.puaprelevanceoftheprogrampagedata.meta.keywords}
      description={data.puaprelevanceoftheprogrampagedata.meta.description}
    >
      {/* Блок первого экрана для каждой страницы (выбор из трёх вариантов)*/}
      {/* Начало */}

      {data.puaprelevanceoftheprogrampagedata.firstscreen.firstscreentype ===
      "video" ? (
        <section className={styles.main__firstscreenvideo}>
          <div className={styles.main__firstscreenvideo__container}>
            <FirstScreenVideo
              h1title={
                data.puaprelevanceoftheprogrampagedata.firstscreen.h1title
              }
              h1subtitle={
                data.puaprelevanceoftheprogrampagedata.firstscreen.h1subtitle
              }
              altimage={
                data.puaprelevanceoftheprogrampagedata.firstscreen.imagealt
              }
              nameimage={
                data.puaprelevanceoftheprogrampagedata.firstscreen.imagename
              }
              urlvideo={
                data.puaprelevanceoftheprogrampagedata.firstscreen.urlvideo
              }
              titlevideo={
                data.puaprelevanceoftheprogrampagedata.firstscreen.titlevideo
              }
              videobuttontitle={
                data.puaprelevanceoftheprogrampagedata.firstscreen
                  .videobuttontitle
              }
              socialnetworkdata={data.socialnetworkdata}
            />
      ...
      {data.puaprelevanceoftheprogrampagedata.landingmonolink.length !== 0 ? (
        <section className={styles.main__landingmonolink}>
          <div className={styles.main__landingmonolink__container}>
            <LandingMonoLink
              landingmonolinkdata={
                data.puaprelevanceoftheprogrampagedata.landingmonolink
              }
      ...
      {Object.keys(data.puaprelevanceoftheprogrampagedata.faq).length !== 0 ? (
        <section className={styles.main__faq}>
          <div className={styles.main__faq__container}>
            <Faq
              title={data.puaprelevanceoftheprogrampagedata.faq.faqtitle}
              faqdata={
                data.puaprelevanceoftheprogrampagedata.faq.questionanswer
              }
            />
          </div>
      ...
      {data.puaprelevanceoftheprogrampagedata.landingmultilink.length !== 0 ? (
          ...
          <div className={styles.main__landingmultilink__container}>
            <LandingMultiLink
              listlandingmultilink={
                data.puaprelevanceoftheprogrampagedata.landingmultilink
              }
            />
          </div>
          <div
      ...
      {data.puaprelevanceoftheprogrampagedata.landingmultilink !== 0 ? (
        <FixLinks
          fixlinkdata={data.puaprelevanceoftheprogrampagedata.landingmultilink}
        />
      ) : null}
    </MainLayout>
  );
...
export async function getStaticProps({ locale }) {
  ...
  const res = await fetch(
    `${process.env.FETCH_URL}:5000/api/puaprelevanceoftheprogram_${lang}`
  );
