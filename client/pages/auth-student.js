...
export default function Authstudent({ data }) {
  return (
    ...
    >
      ...
      {data.authstudentpagedata.landingmonolink.length !== 0 ? (
      ...
      {Object.keys(data.authstudentpagedata.faq).length !== 0 ? (
      ...
      {data.authstudentpagedata.landingmultilink.length !== 0 ? (
      ...
      {data.authstudentpagedata.landingmultilink !== 0 ? (
